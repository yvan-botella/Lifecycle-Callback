...
import com.wanwan.lifecyclecallback.kotlin.callback.FragmentSupportLifecycleCallbacks
import com.wanwan.lifecyclecallback.kotlin.protocol.FragmentSupportLifecycleImpl
...
open class LifecycleFragmentSupport : Fragment(), FragmentSupportLifecycleImpl {
    ...
    override var callbacks = HashMap<Class<*>, FragmentSupportLifecycleCallbacks>()
